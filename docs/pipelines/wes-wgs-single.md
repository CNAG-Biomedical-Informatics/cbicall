...
=== "Bash"
    ??? Example "See Bash pipeline:"
        ...
        ```bash
        --8<-- "https://raw.githubusercontent.com/CNAG-Biomedical-Informatics/cbicall/refs/heads/main/workflows/bash/gatk-4.6/wes_single.sh"
        ```

=== "Snakemake"

    ??? Example "See Snakemake pipeline:"

        ```bash
        --8<-- "https://raw.githubusercontent.com/CNAG-Biomedical-Informatics/cbicall/refs/heads/main/workflows/snakemake/gatk-4.6/wes_single.smk"
        ```
---
