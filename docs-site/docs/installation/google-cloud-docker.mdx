...
> run used the same CBIcall checkout, parameters YAML, Docker image, and selected
> resource as the local test. CBIcall resolved the same workflow
> implementation and resource identity, and the generated VCF matched the
